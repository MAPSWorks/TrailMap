...
INCLUDEPATH += ../..
HEADERS     = KarttapaikkaPlugin.h \
              Coordinates.h
SOURCES     = KarttapaikkaPlugin.cpp \
              Coordinates.cpp

# TODO: Fix for non-Android only!
!unix {
    TARGET      = $$qtLibraryTarget(KarttapaikkaPlugin)
    DESTDIR     = ../../plugins
}

# TODO: Fix Android lib issue.
INCLUDEPATH += ../../proj-4.8.0/src
SOURCES += ../../proj-4.8.0/src/vector1.c \
...
HEADERS += ../../proj-4.8.0/src/projects.h \
